...
export const isMediaType = (e: string): e is typeof MediaType[number] =>
  isInList(e, MediaType);
...
type MediaAndDisInformation = MediaAndDisInfoGeneral;
...
export type { MediaAndDisInfoGeneral, MediaAndDisInformation };
